<template>
  <div class="bg-zinc-950 text-zinc-100">
    ...
    <div class="px-6 py-4">
      ...
      <div v-else-if="resourceStore.error" class="text-center py-8 text-destructive">
        {{ resourceStore.error }}
      </div>
      
      <div v-else-if="resourceStore.resources.length === 0" class="text-center py-8 text-muted-foreground">
      ...
      <!-- Pagination -->
      <div v-if="resourceStore.totalPages > 1" class="mt-8 flex justify-center gap-2">
        <Button
...
import ResourceCard from '@/components/custom/ResourceCard.vue'
