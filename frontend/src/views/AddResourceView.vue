      ...
      <template #content>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label for="url" class="flex text-sm font-medium mb-1 items-center">
                ...
                <VueSpinner v-if="prefetching" class="ml-2" :size="16"
                :color="'#6366F1'" />
              </label>
              <InputText id="url" type="url" v-model="formData.url" placeholder="https://"
                :class="{ 'p-invalid': errors.url }" class="w-full" @paste="preFetchUrl">
                <template #prefix>
            ...
            <div v-if="urlPasted">
              ...
              <InputText id="title" type="text" v-model="formData.title" placeholder="e.g., JavaScript.info"
                :class="{ 'p-invalid': errors.title }" class="w-full">
                <template #prefix>
            ...
            <div v-if="false">
              ...
              <div class="flex flex-col gap-3">
                <InputText id="image" type="url" v-model="formData.image" placeholder="https://" class="w-full">
                  <template #prefix>
            ...
            <div v-if="urlPasted">
              ...
              <Select id="type" v-model="formData.type" :options="typeOptions" optionLabel="label" optionValue="value"
            ...
            <div v-if="urlPasted">
              ...
              <Select id="level" v-model="formData.skillLevel" :options="skillLevelOptions" optionLabel="label"
                optionValue="value" placeholder="Select skill level" class="w-full">
                <template #value="slotProps">
                  <div v-if="slotProps.value" class="flex items-center">
            ...
            <div v-if="urlPasted">
              ...
              <div class="flex flex-wrap gap-2 mb-2">
                <Chip v-for="tag in formData.tags" :key="tag" :label="tag" :removable="true" @remove="removeTag(tag)"
          ...
          <div v-if="urlPasted" class="text-sm text-gray-500">
            <p>*Note: The resource type, skill level, and tags are not updated based on the URL you provided.</p>
          ...
          <div class="flex justify-between gap-4 pt-4" v-if="urlPasted">
            <Button icon="pi pi-times" class="flex-1/2" type="button" variant="text" severity="secondary"
...
import type { ResourceType, SkillLevel } from '@common/types/resource'
